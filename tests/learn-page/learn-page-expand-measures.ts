...
test.describe('[TC-941] - Definitions and conditions expand', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('Check expand of condition DALY', async ({ page }) => {
    ...
    test('Check expand of condition YLL', async ({ page }) => {
    ...
    test('Check expand of condition YLD', async ({ page }) => {
    ...
    test('Check expand of condition Prevalence', async ({ page }) => {
    ...
    test('Check expand of condition Incidence', async ({ page }) => {
    ...
    test('Check expand of condition Risk factor', async ({ page }) => {
