...
test.describe('[TC-941] - Other definitions expand', () => {
  ...
  test.beforeEach(async ({ page }) => {
    ...
    test('Check expand of Nursing facility based care rate', async ({ page }) => {
    ...
    test('Check expand of Community based care', async ({ page }) => {
    ...
    test('Check expand of Community based care vs. nursing facility based care, Unit Costs', async ({ page }) => {
    ...
    test('Check expand of Attributable dementia spending', async ({ page }) => {
    ...
    test('Check expand of Uncertainty interval', async ({ page }) => {
