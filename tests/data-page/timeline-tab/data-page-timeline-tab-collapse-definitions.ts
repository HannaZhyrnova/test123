...
test.describe('[TC-995] - Collapse definitions on Population trends tab', () => {
...
let data: DataPage;
    ...
    test('DALY definition on Population trends tab', async ({ page }) => {
    ...
    test('YLL definition on Population trends tab', async ({ page }) => {
    ...
    test('YLD definition on Population trends tab', async ({ page }) => {
    ...
    test('Prevalence and Incidence definition on Population trends tab', async ({ page }) => {
        ...
        await page.locator('text=Prevalence and Incidence >> nth=0').click();
        await expect(page.locator('text=Prevalence is the total number of cases of a disease or injury in a population. Incidence is the total number of new cases of a disease or injury in a given period.')).toHaveCount(0);
    });
