...
test.describe('[TC-994] - Expand definitions on Timeline tab', () => {
...
let data: DataPage;
    ...
    test('Expand DALY definition on Timeline tab', async ({ page }) => {
    ...
    test('Expand YLL definition on Timeline tab', async ({ page }) => {
    ...
    test('Expand YLD definition on Timeline tab', async ({ page }) => {
    ...
    test('Expand Prevalence and Incidence definition on Timeline tab', async ({ page }) => {
