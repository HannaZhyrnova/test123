...
test.describe('[TC-993] - Collapse definitions on Map Chart tab', () => {
...
let data: DataPage;
    ...
    test('DALY definition on Map Chart tab', async ({ page }) => {
    ...
    test('YLL definition on Map Chart tab', async ({ page }) => {
    ...
    test('YLD definition on Map Chart tab', async ({ page }) => {
    ...
    test('Prevalence and Incidence definition on Map Chart tab', async ({ page }) => {
